...
| C4 | Webhook atrasado e fora de ordem validados pela suite | OK | `C:/dev/concursomestre/scripts/checks/billing-e2e-report.json`<br>`C:/xampp/htdocs/questao-pro-backend/modules/subscriptions/services/SubscriptionsService.php`<br>`C:/xampp/htdocs/questao-pro-backend/api/subscriptions/stripe_webhook.php` |
...
| E5 | Renovacao Stripe ponta a ponta com Stripe real | OK | `C:/dev/concursomestre/scripts/checks/billing-e2e-report.json`<br>`C:/xampp/htdocs/questao-pro-backend/modules/subscriptions/services/SubscriptionsService.php`<br>`C:/dev/concursomestre/src/app/profile/page.tsx` |
...
| F3 | Estrategia canonica de pro-rata definida | OK | `C:/dev/concursomestre/scripts/checks/billing-e2e-report.json`<br>`C:/xampp/htdocs/questao-pro-backend/modules/subscriptions/services/SubscriptionsService.php` |
...
| G4 | Refund concorrente coberto pela suite | OK | `C:/dev/concursomestre/scripts/checks/billing-e2e-report.json`<br>`C:/xampp/htdocs/questao-pro-backend/modules/subscriptions/services/SubscriptionsService.php` |
