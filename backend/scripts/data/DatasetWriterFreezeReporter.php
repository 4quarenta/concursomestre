    ...
    public static function matrix(): array
    {
        ...
        return [
            ...
            self::writer('frontend-next-server', 'concursomestre-frontend.service', 'Node/Next.js', 'HTTP', 'continuous',
                [], 'frontend ingress', 'NOT_A_WRITER', 'stop as part of full maintenance to prevent mutation proxy/UI traffic', 'start and health-check before nginx ingress',
            ...
            self::writer('python-extractor', 'concursomestre-python-extractor.service', 'Python/uvicorn', 'HTTP from admin', 'continuous',
                [], 'document extraction', 'NOT_A_WRITER', 'stop after ingress barrier; no DB connection exists', 'start before frontend ingress',
