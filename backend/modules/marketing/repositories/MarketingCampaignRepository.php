...
final class MarketingCampaignRepository
{
    ...
    public function ensureSchema(): void
    {
        ...
        SchemaReadiness::assertTablesAndColumns($this->db, 'marketing campaigns', [
            ...
            'marketing_campaigns' => ['id', 'name', 'objective', 'status', 'priority', 'starts_at', 'ends_at', 'segment_id', 'rules_json', 'channels_json', 'placements_json', 'content_json', 'landing_slug', 'offer_json', 'plan_id', 'coupon_code', 'tracking_json', 'frequency_cap', 'cooldown_hours', 'max_impressions', 'mutual_exclusion_group', 'suppress_after_conversion', 'created_by', 'updated_by', 'created_at', 'updated_at'],
    ...
    public function saveCampaign(array $campaign): array
    {
        ...
        $stmt = $this->db->prepare("INSERT INTO marketing_campaigns (
                ...
                tracking_json, frequency_cap, cooldown_hours, max_impressions, mutual_exclusion_group,
                ...
                tracking_json = VALUES(tracking_json), frequency_cap = VALUES(frequency_cap), cooldown_hours = VALUES(cooldown_hours),
