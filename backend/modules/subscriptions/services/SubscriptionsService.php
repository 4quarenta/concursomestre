...
class SubscriptionsService
{
    ...
    public function changePlan(string $userId, array $data): array { require_once __DIR__ . '/CanonicalPlanChangeService.php'; return (new CanonicalPlanChangeService($this->db, $this->repository, $this->validator, fn (string $id): array => $this->syncCurrentUserStripeState($id)))->changePlan($userId, $data); }
    /**
