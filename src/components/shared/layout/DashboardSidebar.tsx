...
export const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ type, activeTab, onTabChange, tabs }) => {
    ...
    const handleLogout = () => {
        logout();
        window.location.href = '/#/auth'; // For̤a redirecionamento via URL para garantir limpeza total
    };
            ...
            <div className="p-6 border-b border-slate-50 dark:border-slate-800">
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Gesṭo de Sistema</p>
                    </div>
                </div>
            </div>
