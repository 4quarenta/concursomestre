...
import type { MarketingLandingPage, Plan, PlanName, SystemSettings } from '@/types';
import {
...
interface MarketingPlansLandingClientProps {
  slug: string;
  siteName: string;
  plans: Plan[];
...
const MarketingPlansLandingClient = ({
  slug,
  siteName,
  plans,
  systemSettings,
  ...
  useEffect(() => {
    ...
    setTrackingQueryString(serialized ? `?${serialized}` : '');
  }, []);
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[minmax(0,1fr),420px] lg:items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <a
                href={featuredCard?.checkoutHref || appendTracking('/planos')}
...
export default MarketingPlansLandingClient;
