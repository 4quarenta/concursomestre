                ...
                {isSignup && (
                  <label className="flex items-start gap-3 p-3.5 bg-slate-50 dark:bg-slate-800/50 rounded-2xl cursor-pointer hover:bg-indigo-50/50 dark:hover:bg-slate-800 transition-colors">
                    ...
                    <span className="text-[11px] font-medium text-slate-600 dark:text-slate-400 leading-relaxed">
                      Li e aceito os{' '}
                      <Link href="/terms" className="text-indigo-600 dark:text-indigo-400 font-bold hover:underline">Termos de Uso</Link>
                      {' '}e a{' '}
                      <Link href="/privacy" className="text-indigo-600 dark:text-indigo-400 font-bold hover:underline">Política de Privacidade</Link>.
                    </span>
                  </label>
                )}
