...
import {
  AI_KIND_LABEL,
  ARTICLE_AI_GENERATION_CARDS,
  type AdminLawDraft,
  type AdminLawSectionOverview,
  CreatableTaxonomySelect,
  FieldLabel,
  type GeneratedArticleContentKind,
  LEGAL_BLOCK_KINDS,
  LEGAL_BLOCK_KIND_LABEL,
  LEGAL_UPDATE_CHANGE_LABEL,
  type LegalAiBulkProgress,
  type LegalAiBulkTask,
  type LegalAiGenerationKind,
  type LegalArticleAiKind,
  SelectInput,
  type TaxonomyOption,
  TextArea,
  TextInput,
  buildAreasFromSubjects,
  buildArticleTextFromBlocks,
  buildDefaultBlockLabel,
  buildEmptyArticle,
  buildEmptyEditorialCounts,
  buildEmptyLaw,
  buildLegalAreaFromTaxonomy,
  buildSingleSectionAnalysisBlocks,
  buildSingleSectionAnalysisHtml,
  createTempId,
  formatLegalUpdateDate,
  formatLocalDateTimeForApi,
  formatSectionRange,
  getArticleEditorialCounts,
  getArticleLabel,
  getErrorMessage,
  getLegalAreaId,
  getMissingArticleAiRequirements,
  getTargetedTextBody,
  getTargetedTextTarget,
  getTeacherCommentTarget,
  hasLegalRichBlockContent,
  hasMeaningfulJurisprudenceContent,
  hasTaxonomyPayload,
  hydrateDraftFromLaw,
  isEmptyJurisprudencePlaceholderText,
  isLikelyEditoriallyIrrelevantArticle,
  isNumericOnlyLabel,
  mergeExamTipsByTarget,
  mergeTeacherCommentsByTarget,
  normalizeAdminPublicationDate,
  normalizeAdminPublicationTime,
  normalizeArticleBlocks,
  normalizeArticleForSave,
  normalizeParam,
  normalizeTaxonomyText,
  parseAdminPublicationDateTime,
  resolveAiScope,
  sanitizeLegacyTaxonomyLabel,
  slugifyTaxonomy,
  splitKnowledgeTaxonomies,
  sumEditorialCounts,
  updateTargetedTextItem,
  updateTeacherCommentRichBody,
  updateTeacherCommentTarget,
