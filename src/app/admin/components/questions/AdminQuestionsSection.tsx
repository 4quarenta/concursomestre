                  ...
                  <td className="p-4">
                    {hasComment ? (
                      ...
                      <button
                        ...
                        className="px-2 py-1 rounded text-[9px] font-black uppercase bg-indigo-100 dark:bg-indigo-900/40 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-200 dark:hover:bg-indigo-900/60 transition-colors"
