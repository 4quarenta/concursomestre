...
export const normalizeProvaRecord = (raw: unknown): Prova | null => {
  ...
  return {
    ...
    publishedAt: toText(pickRecordValue(rawRecord, metadataRecord, ['publishedAt', 'published_at'])),
    questionCount: toNumber(pickRecordValue(rawRecord, metadataRecord, ['questionCount', 'question_count']), 0),
    createdAt: toText(pickRecordValue(rawRecord, metadataRecord, ['createdAt', 'created_at'])),
    updatedAt: toText(pickRecordValue(rawRecord, metadataRecord, ['updatedAt', 'updated_at'])),
