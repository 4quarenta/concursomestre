...
export const DEFAULT_SEO_SETTINGS: SeoSettings = {
  global: {
    ...
    default_og_description: 'Mais que um banco de questoes. Uma plataforma completa para acelerar sua aprovacao.',
    default_og_image: '',
    default_twitter_title: 'ConcursoMestre',
    default_twitter_description: 'Questoes, simulados e estatisticas para acelerar sua aprovacao.',
