        ...
        <div className="max-w-6xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          <div className="text-left max-w-2xl">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
              Acompanhe todas as novidades, melhorias e correcoes feitas no <span className="text-indigo-600 dark:text-indigo-400">ConcursoMestre</span>.
            </p>
          </div>
        ...
        {errorMessage ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            <div className="lg:col-span-1 space-y-6">
              <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Versoes lancadas</h3>
            ...
            <div className="lg:col-span-3 space-y-10">
              {selectedVersion ? (
                  ...
                  <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                    <div className="flex flex-wrap items-center gap-3 mb-6">
                      ...
                      <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">
                        Data de lancamento: {new Date(selectedVersion.release_date).toLocaleDateString()}
                      </span>
                    </div>
                ...
                <div className="text-center py-20 text-slate-400">
                  ...
                  <p className="font-bold">Nenhuma versao publicada ainda.</p>
                </div>
              )}
            </div>
          </div>
