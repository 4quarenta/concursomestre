...
import { buildRankingStructuredData, serializeStructuredData } from '@/lib/structuredData';
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: serializeStructuredData(buildRankingStructuredData(ranking)) }}
      />
