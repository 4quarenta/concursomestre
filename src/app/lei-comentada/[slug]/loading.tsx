    ...
    <div className="w-full space-y-6 animate-fade-in">
      ...
      <div className="grid gap-6 xl:grid-cols-[300px_minmax(0,1fr)]">
        <aside className="hidden xl:block xl:self-start">
          <section className="sticky top-0 rounded-[2rem] border border-slate-200 bg-white p-4 shadow-xl shadow-slate-200/60 dark:border-slate-800 dark:bg-slate-900 dark:shadow-none">
        ...
        <section className="space-y-5">
          <section className="space-y-4 rounded-[2rem] border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 md:p-5">
