...
- Consolida arquitetura oficial, limpeza estrutural, freeze tecnico e regras transversais.
- O entrypoint frontend agora vive em `src/main.tsx` e `src/App.tsx`.
- Regras locais de `src/state` e `src/utils` foram absorvidas aqui.

## Arquivos absorvidos

- `C:\dev\concursomestre\docs\architecture-freeze.md`
- `C:\dev\concursomestre\docs\architecture-status.md`
- `C:\dev\concursomestre\docs\audit-report.md`
- `C:\dev\concursomestre\docs\api-residual-surface.md`
- `C:\dev\concursomestre\docs\api-root-cleanup.md`
- `C:\dev\concursomestre\docs\backend-root-cleanup.md`
- `C:\dev\concursomestre\docs\cache-runtime-hardening.md`
- `C:\dev\concursomestre\docs\cron-secret-hardening.md`
- `C:\dev\concursomestre\docs\frontend-bundle-splitting.md`
- `C:\dev\concursomestre\docs\legacy\ARCHITECTURE_README.md`
- `C:\dev\concursomestre\docs\legacy\LEGACY.md`
- `C:\dev\concursomestre\docs\migration-scripts-reclassification.md`
- `C:\dev\concursomestre\docs\shared-auth-middleware-extraction.md`
- `C:\dev\concursomestre\docs\shared-module-dependency-cleanup.md`
- `C:\dev\concursomestre\docs\shared-utils-security-extraction.md`
- `C:\dev\concursomestre\src\state\README.md`
- `C:\dev\concursomestre\src\utils\README.md`

---

## Fonte absorvida: `C:\dev\concursomestre\docs\architecture-freeze.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\architecture-status.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\audit-report.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\api-residual-surface.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\api-root-cleanup.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\backend-root-cleanup.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\cache-runtime-hardening.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\cron-secret-hardening.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\frontend-bundle-splitting.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\legacy\ARCHITECTURE_README.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\legacy\LEGACY.md`
...
### Frontend
- âœ… **data/** - REMOVED (migrated to @core/api)
  - `api.ts` â†’ `src/core/api/client.ts`
  - `materials.ts` â†’ Integrated into marketplace service

- âœ… **services/** - REMOVED (migrated to features)
  - `questionService.ts` â†’ `src/features/questions/services/questionService.ts`
  - `commentService.ts` â†’ `src/features/comments/services/commentService.ts`
  - `notificationService.ts` â†’ `src/features/notifications/services/notificationService.ts`
  - `marketplaceService.ts` â†’ `src/features/marketplace/services/marketplaceService.ts`
  - `reputationService.ts` â†’ `src/features/auth/services/reputationService.ts`
  - `geminiService.ts` â†’ `src/features/questions/services/aiService.ts`
...
â”œâ”€â”€ endpoints.ts    - Clean URL endpoints
â”œâ”€â”€ types.ts        - Shared API types
...
```
src/features/
â”œâ”€â”€ questions/services/
â”‚   â”œâ”€â”€ questionService.ts  - Question operations
â”‚   â””â”€â”€ aiService.ts        - AI/Gemini integration
â”œâ”€â”€ comments/services/
â”‚   â””â”€â”€ commentService.ts   - Comment operations
â”œâ”€â”€ notifications/services/
â”‚   â””â”€â”€ notificationService.ts - Notification operations
â”œâ”€â”€ marketplace/services/
â”‚   â””â”€â”€ marketplaceService.ts - Materials & transactions
â”œâ”€â”€ auth/services/
â”‚   â””â”€â”€ reputationService.ts - XP & reputation
â”œâ”€â”€ rankings/services/
â”‚   â””â”€â”€ rankingsService.ts  - Leaderboards
â””â”€â”€ bank-analysis/services/
    â””â”€â”€ bankAnalysisService.ts - Analytics
```
...
## Fonte absorvida: `C:\dev\concursomestre\docs\migration-scripts-reclassification.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\shared-auth-middleware-extraction.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\shared-module-dependency-cleanup.md`
...
## Fonte absorvida: `C:\dev\concursomestre\docs\shared-utils-security-extraction.md`
...
## Fonte absorvida: `C:\dev\concursomestre\src\state\README.md`
...
## Fonte absorvida: `C:\dev\concursomestre\src\utils\README.md`
