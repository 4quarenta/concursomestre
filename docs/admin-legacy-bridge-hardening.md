...
- endpoint oficial de logs em `C:\xampp\htdocs\questao-pro-backend\api\admin\logs.php`
- bridge legado `C:\xampp\htdocs\questao-pro-backend\api\system\logs.php`
- alias legado `settingsUpdate` alinhado para `api/admin/settings.php` em `.htaccess` e `router.php`
- teste estrutural `C:\xampp\htdocs\questao-pro-backend\tests\AdminLegacyBridgesWiringTest.php`

## Estado atual de `api/admin`
Todos os arquivos da pasta delegam para `modules/admin/routes.php` e nao concentram regra de negocio.
