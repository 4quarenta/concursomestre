...
const criticalFiles = [
  ...
  'backend/shared/health/ReleaseReadinessAuthority.php',
  ...
  'backend/modules/admin/routes.php',
  'src/services/admin/adminService.types.ts',
  'src/app/admin/components/settings/AdminLaunchModeControl.tsx',
