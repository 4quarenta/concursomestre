          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div className="space-y-4 max-w-2xl text-white">
              ...
              <p className="text-indigo-100 text-sm md:text-base font-medium opacity-90 leading-relaxed">
                Os Termos e Condições que regem o uso da plataforma ConcursoMestre AI. Leia com atenção para entender nossas diretrizes e o seu papel na comunidade.
              </p>
            </div>
          ...
          <div className="lg:sticky lg:top-24 w-full lg:w-72 shrink-0">
            <div className="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-sm p-4 space-y-1">
              ...
              {[
                ...
                { id: 'servicos', icon: FileText, label: '3. Nossos Serviços' },
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 leading-relaxed transition-colors">
              ...
              <section id="aceite" className="scroll-mt-24 mb-16">
                ...
                <div className="space-y-4">
                  <p className="text-sm md:text-base">
                    Ao acessar e utilizar a plataforma <strong>ConcursoMestre AI</strong>, você concorda de forma irrevogável e irretratável em cumprir e estar vinculado aos presentes Termos de Uso. Este documento de caráter legal estabelece as obrigações que devem ser cumpridas entre você (o Usuário) e a ConcursoMestre AI.
                  </p>
                  <p className="text-sm md:text-base">
              ...
              <section id="servicos" className="scroll-mt-24 mb-16">
                ...
                <div className="space-y-4 text-sm md:text-base">
                  <p>
                    A ConcursoMestre AI é dotada de funcionalidades orientadas por modelos de Inteligência Artificial para facilitar seus momentos de estudo: resoluções passo a passo, resumos automáticos e análise de perfil preditiva.
                  </p>
              ...
              <section id="responsabilidade" className="scroll-mt-24 mb-16">
                ...
                <p className="text-sm md:text-base mb-6">
                  Esforçamo-nos para manter a estabilidade de sistema (uptime de 99%), porém o ConcursoMestre AI não é civil ou materialmente responsável caso danos ocorram decorrentes de:
                </p>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-4 p-5 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm transition-all hover:border-red-200 dark:hover:border-red-900/50">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-300 font-medium">Roubos de senhas caso o usuário não exerça as medidas prudentes de salvaguardar seu acesso de ataques de Phishing originados fôra do ecossistema do site do ConcursoMestre AI.</p>
                  </div>
                </div>
              </section>
