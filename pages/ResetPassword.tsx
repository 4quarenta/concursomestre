...
import {
    KeyRound, Lock, Eye, EyeOff, Loader2,
    CheckCircle2, AlertCircle, ArrowLeft, BrainCircuit
} from 'lucide-react';
...
const ResetPasswordPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Se o usuário estiver logado, o e-mail deve coincidir com o do link de redefinição
        if (currentUser && emailFromUrl && currentUser.email !== emailFromUrl) {
            setError('Este link de redefinição pertence a outra conta. Faça logout ou use a conta correta.');
        }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res: any = await apiClient.post('/auth/reset-password.php', {
                token,
                password
            });
